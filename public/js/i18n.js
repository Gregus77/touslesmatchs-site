...
const i18n = (function () {
  const translations = {
    fr: {
      ...
      plan_std_2: "Accès historique · signal officiel : minimum 3 IA sur 5 concordantes",
      plan_prem: "PREMIUM", plan_prem_1: "Tous les signaux admissibles, sans plafond quotidien",
      plan_prem_2: "Minimum 3 IA sur 5 concordantes · tous les signaux admissibles",
      plan_nocommit: "Sans engagement", plan_popular: "Le plus choisi",
      plan_month: "/mois",
      plan_btn_std: "Choisir Premium", plan_btn_prem: "Choisir Premium",
      plans_note: "Aucun quota quotidien de signaux Premium. Le nombre réel de sélections dépend des matchs atteignant les critères du Concile.<br>Le score de confiance est un indicateur interne d'analyse. Le résultat d'un événement sportif reste incertain.",
    ...
    en: {
      ...
      plan_prem: "PREMIUM", plan_prem_1: "All eligible signals, no daily cap",
      ...
      plans_note: "Premium has no daily signal cap. The actual number of selections depends on how many matches meet the Council's criteria.<br>The confidence score is an internal analysis indicator. The outcome of a sporting event remains uncertain.",
    ...
    es: {
      ...
      plan_prem: "PREMIUM", plan_prem_1: "Todas las señales admisibles, sin límite diario",
      ...
      plans_note: "Premium no tiene límite diario de señales. El número real de selecciones depende de los partidos que cumplan los criterios del Concilio.<br>La puntuación de confianza es un indicador interno de análisis. El resultado de un evento deportivo sigue siendo incierto.",
    ...
    pt: {
      ...
      plan_prem: "PREMIUM", plan_prem_1: "Todos os sinais elegíveis, sem limite diário",
      ...
      plans_note: "Premium não tem limite diário de sinais. O número real de seleções depende dos jogos que cumprem os critérios do Concílio.<br>A pontuação de confiança é um indicador interno de análise. O resultado de um evento desportivo permanece incerto.",
    ...
    ru: {
      ...
      plan_prem: "PREMIUM", plan_prem_1: "Все подходящие сигналы без дневного лимита",
      ...
      plans_note: "В Premium нет дневного лимита сигналов. Фактическое количество отборов зависит от числа матчей, отвечающих критериям Совета.<br>Уровень уверенности — это внутренний аналитический показатель. Исход спортивного события остаётся неопределённым.",
    ...
    zh: {
      ...
      plan_prem: "PREMIUM", plan_prem_1: "所有符合条件的信号，无每日数量上限",
      ...
      plans_note: "Premium 无每日信号数量上限。实际分析数量取决于有多少场比赛达到评议会的标准。<br>置信度为内部分析指标。体育赛事的结果始终存在不确定性。",
