...
const I18N = {
  fr: {
    ...
    tg_free:"📢 Gratuit — Canal public", tg_pro:"⚡ Pro — Analyses Live IA", tg_elite:"👑 Elite — Signaux forts + Live IA",
    ...
    paywall_title:"Réservé aux membres Pro et Elite",
    ...
    plan_pop:"Populaire",
    plan_pro_desc:"10 analyses Live IA par jour + groupe Telegram Pro.",
    plan_pro_btn:"S'abonner — 9.90€/mois",
    plan_elite_desc:"30 analyses Live IA par jour + alertes Elite sur les signaux forts.",
  ...
  en: {
    ...
    tg_free:"📢 Free — Public channel", tg_pro:"⚡ Pro — Live AI picks", tg_elite:"👑 Elite — Priority picks + Live AI",
    ...
    paywall_title:"Pro and Elite members only",
    ...
    plan_elite_desc:"30 analyses/day + Telegram Elite + strong-signal alerts + support.",
  ...
  es: {
    ...
    tg_free:"📢 Gratis — Canal público", tg_pro:"⚡ Pro — Picks Live IA", tg_elite:"👑 Elite — Picks prioritarios + Live IA",
    ...
    paywall_title:"Solo para miembros Pro y Elite",
    ...
    plan_elite_desc:"30 análisis/día + Telegram Elite + alertas fuertes.",
  ...
  pt: {
    ...
    tg_free:"📢 Grátis — Canal público", tg_pro:"⚡ Pro — Picks premium", tg_elite:"👑 Premium — Picks prioritários + Live IA",
  ...
  de: {
    ...
    tg_free:"📢 Kostenlos — Öffentlicher Kanal", tg_pro:"⚡ Pro — Premium Picks", tg_elite:"👑 Premium — Priority Picks + Live KI",
  ...
  it: {
    ...
    tg_free:"📢 Gratuito — Canale pubblico", tg_pro:"⚡ Pro — Pick premium", tg_elite:"👑 Premium — Pick prioritari + Live IA",
  ...
  nl: {
    ...
    tg_free:"📢 Gratis — Publiek kanaal", tg_pro:"⚡ Pro — Premium picks", tg_elite:"👑 Premium — Priority picks + Live AI",
    ...
    plan_elite_desc:"30 analyses/dag + Telegram Premium + prioriteitstoegang.",
  ...
  tr: {
    ...
    tg_free:"📢 Ücretsiz — Açık Kanal", tg_pro:"⚡ Pro — Premium Seçimler", tg_elite:"👑 Premium — Öncelikli seçimler + Canlı YZ",
  ...
  ru: {
    ...
    tg_free:"📢 Бесплатно — Публичный канал", tg_pro:"⚡ Pro — Премиум пики", tg_elite:"👑 Premium — Priority picks + Live ИИ",
  ...
  zh: {
    ...
    tg_free:"📢 免费 — 公共频道", tg_pro:"⚡ Pro — 高级推荐", tg_elite:"👑 Premium — Priority picks + 实时AI",
  ...
  ar: {
    ...
    tg_free:"📢 مجاني — قناة عامة", tg_pro:"⚡ Pro — اختيارات مميزة", tg_elite:"👑 Premium — Priority picks + مباشر AI",
