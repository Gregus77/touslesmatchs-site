const i18n = (function(){
  const translations = {
    fr: {
      ...
      plan_pop: "Populaire",
      plan_standard_desc: "Le tri ultra-sélectif : jusqu’à 3 signaux/jour, confiance ≥ 88%, cote réelle ARJEL ≥ 1.50.",
      plan_standard_btn: "S’abonner — 4.90€/mois",
      plan_pro_desc: "Plus de volume exploitable : jusqu’à 10 signaux/jour, confiance ≥ 90%, avant-match ou live.",
