const i18n = (function(){
  const translations = {
    fr: {
      pick_today: "Signal du jour",
      nav_join: "Abonnements",
      nav_cta: "Commencer →",
      mm_home: "🏠 Accueil",
      mm_hist: "📊 Historique des signaux",
      ...
      sec_next_eye: "Concile · Signaux en direct",
      sec_next_title: "Résultats & Prochain Signal",
      sec_pick_eye: "Concile · analyse du jour",
      sec_roi_eye: "Performance",
      sec_roi_title: "Résultats réels · tracés signal par signal",
      lbl_winrate: "Winrate",
      lbl_picks_month: "Signaux analysés",
      sec_plans_eye: "Abonnements",
      sec_plans_title: "Un plan pour chaque niveau d'ambition",
      sec_plans_sub: "Du signal gratuit au Live IA complet — accès immédiat après paiement.",
