const i18n = (function(){
  const translations = {
    fr: {
      ...
      plan_pop: "Populaire",
      plan_standard_desc: "Le tri le plus sévère : jusqu’à 3 signaux/jour, confiance ≥ 92%, cote réelle ARJEL ≥ 1.50.",
      plan_standard_btn: "S’abonner — 4.90€/mois",
      plan_pro_desc: "Plus de volume exploitable : jusqu’à 10 signaux/jour, confiance ≥ 88%, avant-match ou live.",
      plan_pro_btn: "S’abonner — 9.90€/mois",
      plan_elite_desc: "Le radar complet multisport : jusqu’à 30 signaux/jour (foot, basket, hockey, baseball) + alertes prioritaires.",
      ...
      pf_preview_lock: "Réservé aux abonnés Standard, Premium & Elite",
      pf_btn: "Voir l’analyse complète",
      pf_hint: "Disponible pour les abonnés Standard, Premium et Elite",
      logout: "Déconnexion",
