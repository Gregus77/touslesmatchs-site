const i18n = (function(){
  const translations = {
    fr: {
      ...
      plan_pop: "Populaire",
      plan_standard_desc: "Le tri le plus sévère : jusqu’à 3 signaux/jour, confiance ≥ 82%, cote réelle ANJ entre 1.30 et 2.50.",
      plan_standard_btn: "S’abonner — 4.90€/mois",
      plan_pro_desc: "Plus de volume exploitable : jusqu’à 10 signaux/jour, confiance ≥ 82%, avant-match ou live.",
