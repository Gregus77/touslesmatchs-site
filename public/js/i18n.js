...
const I18N = {
  fr: {
    ...
    hero_t1:"Le Concile analyse.", hero_t2:"Tu encaisses.",
    hero_sub:"5 intelligences artificielles. 3 sources vérifiées. Un pick par jour, quand et seulement quand les données le justifient.",
    ...
    plan_carte_desc:"Paiement unique — 1 analyse complète sur n'importe quel match en Live IA.",
    plan_pop:"Populaire",
    ...
    step1_title:"Collecte vérifiée à 6h00", step2_title:"Analyse par les 5 IA du Concile",
  ...
  en: {
    ...
    hero_t1:"The Council analyzes.", hero_t2:"You cash in.",
    ...
    step1_title:"Verified data collected at 6am", step2_title:"Analysis by 5 Council AIs",
  ...
  es: {
    ...
    hero_t1:"El Concilio analiza.", hero_t2:"Tú cobras.",
    ...
    plan_carte_desc:"Pago único — 1 análisis completo en cualquier partido en Live IA.",
    ...
    step1_title:"Datos verificados a las 6h", step2_title:"Análisis por las 5 IA del Concilio",
  ...
  nl: {
    ...
    hero_t1:"Het Concilie analyseert.", hero_t2:"Jij incasseert.",
    ...
    step1_title:"Geverifieerde data om 6u", step2_title:"Analyse door 5 AI's van het Concilie",
