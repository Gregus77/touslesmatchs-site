...
const i18n = (function () {
  const translations = {
    fr: {
      ...
      plan_std: "STANDARD", plan_std_1: "Jusqu'a 3 signaux Over/Under 2.5 but/jour",
      plan_std_2: "Score de confiance minimum 82/100, sélection la plus stricte du jour",
      plan_prem: "ELITE", plan_prem_1: "Jusqu'a 10 signaux Over/Under 2.5 but/jour",
      plan_prem_2: "Score de confiance minimum 82/100, sélection élargie",
      plan_elite: "ELITE", plan_elite_1: "Jusqu'a 10 signaux Over/Under 2.5 but/jour",
      plan_elite_2: "Score de confiance minimum 75/100, tout le vivier football diffusable",
      plan_nocommit: "Sans engagement", plan_popular: "Le plus choisi",
      plan_month: "/mois",
      plan_btn_std: "Choisir Standard", plan_btn_prem: "Choisir Intensif",
      plan_btn_elite: "Rejoindre Intensif",
      ...
      method_2d: "Plusieurs IA indépendantes votent séparément.",
    ...
    en: {
      ...
      plan_std_2: "Minimum confidence score 82/100, the day's strictest selection",
      plan_prem: "ELITE", plan_prem_1: "Up to 10 selections/day",
      plan_prem_2: "Minimum confidence score 82/100, broader selection",
      plan_elite: "ELITE", plan_elite_1: "Up to 10 selections/day",
      plan_elite_2: "Minimum confidence score 75/100, the full publishable football pool",
      plan_nocommit: "No commitment", plan_popular: "Most chosen",
      plan_month: "/month",
      plan_btn_std: "Choose Standard", plan_btn_prem: "Choose Intensif",
      plan_btn_elite: "Join Intensif",
      ...
      method_2d: "Several independent AI models vote separately.",
    ...
    es: {
      ...
      plan_std_2: "Puntuación de confianza mínima 82/100, la selección más estricta del día",
      plan_prem: "ELITE", plan_prem_1: "Hasta 10 selecciones/día",
      plan_prem_2: "Puntuación de confianza mínima 82/100, selección ampliada",
      plan_elite: "ELITE", plan_elite_1: "Hasta 10 selecciones/día",
      plan_elite_2: "Puntuación de confianza mínima 75/100, todo el conjunto de fútbol publicable",
      plan_nocommit: "Sin compromiso", plan_popular: "El más elegido",
      plan_month: "/mes",
      plan_btn_std: "Elegir Standard", plan_btn_prem: "Elegir Intensif",
      plan_btn_elite: "Unirse a Intensif",
      ...
      method_2d: "Varias IA independientes votan por separado.",
    ...
    pt: {
      ...
      plan_std_2: "Pontuação de confiança mínima 82/100, a seleção mais rigorosa do dia",
      plan_prem: "ELITE", plan_prem_1: "Até 10 seleções/dia",
      plan_prem_2: "Pontuação de confiança mínima 82/100, seleção alargada",
      plan_elite: "ELITE", plan_elite_1: "Até 10 seleções/dia",
      plan_elite_2: "Pontuação de confiança mínima 75/100, todo o conjunto de futebol publicável",
      plan_nocommit: "Sem compromisso", plan_popular: "O mais escolhido",
      plan_month: "/mês",
      plan_btn_std: "Escolher Standard", plan_btn_prem: "Escolher Intensif",
      plan_btn_elite: "Juntar-me ao Intensif",
      ...
      method_2d: "Várias IAs independentes votam separadamente.",
    ...
    ru: {
      ...
      plan_std_2: "Минимальный уровень уверенности 82/100, самый строгий отбор дня",
      plan_prem: "ELITE", plan_prem_1: "До 10 отборов в день",
      plan_prem_2: "Минимальный уровень уверенности 82/100, расширенный отбор",
      plan_elite: "ELITE", plan_elite_1: "До 10 отборов в день",
      plan_elite_2: "Минимальный уровень уверенности 75/100, весь публикуемый футбольный пул",
      plan_nocommit: "Без обязательств", plan_popular: "Выбирают чаще всего",
      plan_month: "/месяц",
      plan_btn_std: "Выбрать Standard", plan_btn_prem: "Выбрать Intensif",
      plan_btn_elite: "Вступить в Intensif",
      ...
      method_2d: "Несколько независимых ИИ голосуют отдельно.",
    ...
    zh: {
      ...
      plan_std_2: "置信度不低于 82/100，当日最严格的筛选",
      plan_prem: "ELITE", plan_prem_1: "每天最多 10 条分析",
      plan_prem_2: "置信度不低于 82/100，筛选范围更广",
      plan_elite: "ELITE", plan_elite_1: "每天最多 10 条分析",
      plan_elite_2: "置信度不低于 75/100，覆盖全部可发布的足球赛事",
      plan_nocommit: "无需长期承诺", plan_popular: "最多人选择",
      plan_month: "/月",
      plan_btn_std: "选择 Standard", plan_btn_prem: "选择 Intensif",
      plan_btn_elite: "加入 Intensif",
