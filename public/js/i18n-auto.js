...
(function () {
  ...
  var rows = [
    ...
    ["Découvrir Premium","Discover Premium","Descubrir Premium","Conhecer o Premium","Узнать о Premium","了解 Premium"],
    ...
    ["Choisir Premium — 14,90 €/mois","Choose Premium — €14.90/month","Elegir Premium — 14,90 €/mes","Escolher Premium — 14,90 €/mês","Выбрать Premium — 14,90 €/месяц","选择 Premium — 每月 14.90 欧元"],
    ...
    ["↗️ Découvrir Premium","↗️ Discover Premium","↗️ Descubrir Premium","↗️ Conhecer o Premium","↗️ Узнать о Premium","↗️ 了解 Premium"],
    ...
    ["Performance Premium","Premium performance","Rendimiento Premium","Desempenho Premium","Результаты Premium","Premium 表现"],
    ...
    ["Passe Premium","Go Premium","Pásate a Premium","Passe para Premium","Перейти на Premium","升级到 Premium"],
    ...
    ["— tous les signaux admissibles, Telegram Premium, sans plafond quotidien annoncé.","— every eligible signal via Premium Telegram, with no advertised daily cap.","— todas las señales admisibles por Telegram Premium, sin límite diario anunciado.","— todos os sinais elegíveis pelo Telegram Premium, sem limite diário anunciado.","— все допустимые сигналы в Telegram Premium без заявленного дневного лимита.","— 所有符合条件的信号通过 Premium Telegram 发送，不设宣传中的每日上限。"],
    ...
    ["En Live IA, les analyses football ont lieu de la 35e minute à la fin réelle de la première mi-temps, arrêts de jeu compris. Un signal Over/Under 2,5 peut être diffusé de la 35e minute à la fin réelle de la première mi-temps si au moins 3 IA sur 5 concordent et si les autres critères sont remplis. La livraison Telegram est vérifiée séparément.","Live football analyses run from minute 35 until the actual end of the first half, including stoppage time. An Over/Under 2.5 signal can be sent from minute 35 until the actual end of the first half only when at least three of five AIs agree and all other criteria are met. Telegram delivery is verified separately.","Los análisis de fútbol en directo se realizan desde el minuto 35 hasta el final real del primer tiempo. Una señal Más/Menos 2,5 solo puede enviarse desde el minuto 35 hasta el final real del primer tiempo con al menos tres de cinco IA de acuerdo y los demás criterios cumplidos. La entrega de Telegram se verifica por separado.","As análises de futebol ao vivo decorrem do minuto 35 até ao fim real da primeira parte. Um sinal Mais/Menos 2,5 só pode ser enviado do minuto 35 até ao fim real da primeira parte com pelo menos três de cinco IA concordantes e os restantes critérios cumpridos. A entrega no Telegram é verificada à parte.","Футбольный ИИ-анализ проводится с 35-й минуты до фактического конца первого тайма. Сигнал на тотал 2,5 можно отправить с 35-й минуты до фактического конца первого тайма лишь при совпадении минимум трёх голосов из пяти и выполнении остальных критериев. Доставка в Telegram проверяется отдельно.","足球实时分析在第 35 分钟至上半场实际结束进行。大/小 2.5 球信号仅在第 35 分钟至上半场实际结束、至少五个 AI 中三个意见一致且满足其他条件时才可能发送。Telegram 投递需单独验证。"],
    ["Un match peut être écarté s'il est hors périmètre, hors de la fenêtre de première mi-temps à partir de la 35e minute, si les données sont insuffisantes ou si le Concile n'obtient pas au moins 3 votes sur 5 sur Over/Under 2,5.","A match may be excluded when it is outside scope or the first-half window starting at minute 35, when data is insufficient, or when the Council does not obtain at least three matching votes out of five on Over/Under 2.5.","Un partido puede excluirse si está fuera del ámbito o de la ventana del primer tiempo desde el minuto 35, si faltan datos o si el Consejo no obtiene al menos tres votos coincidentes de cinco en Más/Menos 2,5.","Um jogo pode ser excluído se estiver fora do âmbito ou da janela da primeira parte a partir do minuto 35, se os dados forem insuficientes ou se o Conselho não obtiver pelo menos três votos concordantes em cinco em Mais/Menos 2,5.","Матч исключается, если он вне охвата или окна первого тайма с 35-й минуты, если данных недостаточно либо Совет не получил минимум три совпадающих голоса из пяти по тоталу 2,5.","如果比赛不在范围内或不在从第 35 分钟开始的上半场窗口、数据不足，或评议会未在大/小 2.5 球上获得至少五票中的三票一致，则会排除该比赛。"],
    ...
    ["Chaque IA analyse les données exploitables du match. 5/5 = accord unanime ; 3/5 = accord minimal. À 2/5 ou moins : consensus insuffisant — aucun signal. Un accord seul ne garantit ni sélection ni envoi.","Each AI examines usable match data. 5/5 means unanimous agreement; 3/5 is the minimum. With 2/5 or fewer: insufficient agreement, no signal. Agreement alone does not prove selection or delivery.","Cada IA analiza los datos útiles del partido. 5/5 significa unanimidad; 3/5 es el mínimo. Con 2/5 o menos, consenso insuficiente: ninguna señal. El acuerdo no demuestra selección ni entrega.","Cada IA analisa os dados utilizáveis do jogo. 5/5 é unanimidade; 3/5 é o mínimo. Com 2/5 ou menos, consenso insuficiente: nenhum sinal. O acordo não prova seleção nem entrega.","Каждый ИИ анализирует доступные данные матча. 5/5 — единогласие; 3/5 — необходимый минимум. При 2/5 и ниже согласие недостаточно: сигнала нет. Совпадение голосов само по себе не доказывает отбор или доставку.","每个 AI 分析可用比赛数据。5/5 表示一致，3/5 是最低要求；2/5 或更少表示共识不足，不产生信号。意见一致本身不证明已选中或已投递。"],
    ...
    ["De la 35e minute à la fin réelle de la première mi-temps, arrêts de jeu compris, 5 IA analysent le match. Un signal n'est validé qu'avec au moins 3 avis concordants sur 5 et les autres critères de qualité.","From minute 35 until the actual end of the first half, five AIs analyse the match. A signal is validated only with at least three matching opinions out of five and the other quality criteria.","Desde el minuto 35 hasta el final real del primer tiempo, cinco IA analizan el partido. Una señal solo se valida con al menos tres de cinco opiniones coincidentes y los demás criterios de calidad.","Do minuto 35 até ao fim real da primeira parte, cinco IA analisam o jogo. Um sinal só é validado com pelo menos três de cinco pareceres concordantes e os restantes critérios de qualidade.","С 35-й минуты до фактического конца первого тайма матч анализируют пять ИИ. Сигнал допускается только при совпадении минимум трёх голосов из пяти и выполнении остальных критериев качества.","第 35 分钟至上半场实际结束，五个 AI 分析比赛。只有至少五个 AI 中三个意见一致并满足其他质量标准，信号才可能通过验证。"],
    ...
    ["Les sélections Over / Under 2,5 et les alertes membres sont disponibles avec Premium à 14,90 €/mois.","Over / Under 2.5 selections and member alerts are available with Premium for €14.90/month.","Las selecciones Más / Menos 2,5 y las alertas para miembros están disponibles con Premium por 14,90 €/mes.","As seleções Mais / Menos 2,5 e os alertas para membros estão disponíveis com Premium por 14,90 €/mês.","Выборы на тотал больше / меньше 2,5 и уведомления доступны с Premium за 14,90 € в месяц.","大/小 2.5 球推荐和会员提醒包含在每月 14.90 欧元的 Premium 中。"],
    ...
    ["Règle actuelle Premium : football de championnat analysé de la 35e minute à la fin réelle de la première mi-temps, arrêts de jeu compris, diffusion à partir de la 35e jusqu’à la fin réelle de la première mi-temps, au moins 3/5 avis concordants et autres critères de qualité. Tous les signaux admissibles sont proposés, sans plafond quotidien commercial.","Current Premium rule: league football analysed from minute 35 until the actual end of the first half, signals sent from minute 35 until the actual end of the first half, at least 3/5 matching opinions and other quality criteria. All eligible signals are offered, without a commercial daily cap.","Regla Premium actual: fútbol de liga analizado desde el minuto 35 hasta el final real del primer tiempo, señales enviadas desde el minuto 35 hasta el final real del primer tiempo, al menos 3/5 opiniones coincidentes y los demás criterios de calidad. Todas las señales admisibles, sin límite comercial diario.","Regra Premium atual: futebol de campeonato analisado do minuto 35 até ao fim real da primeira parte, envio do minuto 35 até ao fim real da primeira parte, pelo menos 3/5 pareceres concordantes e os restantes critérios de qualidade. Todos os sinais elegíveis, sem limite comercial diário.","Текущее правило Premium: матчи чемпионатов анализируются с 35-й минуты до фактического конца первого тайма, отправка с 35-й минуты до конца первого тайма, минимум 3/5 совпадающих голосов и остальные критерии качества. Все допустимые сигналы без коммерческого суточного лимита.","当前 Premium 规则：联赛在第 35 分钟至上半场实际结束分析，信号在第 35 分钟至上半场实际结束发送，至少 3/5 意见一致且满足其他质量标准。所有合格信号均提供，不设商业每日上限。"],
    ["BON","GOOD","BUENO","BOM","ХОРОШО","良好"],
    ["FIABLE","RELIABLE","FIABLE","FIÁVEL","НАДЁЖНО","可靠"],
...
"Minimum 3 IA sur 5 concordantes":{
fr:"Minimum 3 IA sur 5 concordantes",
en:"At least 3 of 5 AI models must agree",
