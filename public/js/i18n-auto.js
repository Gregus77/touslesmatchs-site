...
(function () {
  ...
  var rows = [
    ...
    ["Données live incomplètes","Incomplete live data","Datos en directo incompletos","Dados em direto incompletos","Неполные данные матча","实时数据不完整"],
    ["Score indisponible","Score unavailable","Marcador no disponible","Resultado indisponível","Счёт недоступен","比分不可用"],
    ["Minute indisponible","Minute unavailable","Minuto no disponible","Minuto indisponível","Минута недоступна","分钟不可用"],
    ["Non calculé","Not calculated","No calculado","Não calculado","Не рассчитано","未计算"],
    ["Cote absente","Odds unavailable","Cuota no disponible","Odd indisponível","Коэффициент отсутствует","赔率不可用"],
