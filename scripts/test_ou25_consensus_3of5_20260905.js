...
assert.match(source, /CLIENT_OU25_MIN_CONFIDENCE\s*=\s*Math\.max\(80,/, "la confiance minimale doit rester a 80");
assert.match(source, /TIER_MIN_REAL_ODD\s*=\s*Math\.max\(1\.50,/, "la cote reelle minimale doit rester a 1,50");
