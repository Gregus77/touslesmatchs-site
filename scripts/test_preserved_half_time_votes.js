...
const front={document:{getElementById:()=>null},esc:String,escHtml:String,TLMMatchLifecycle:require(path.join(root,'public/js/match-lifecycle.js')),liveHomeScore:m=>m.score_home,liveAwayScore:m=>m.score_away};
