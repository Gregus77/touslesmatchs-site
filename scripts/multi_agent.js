...
⚖️ MAIS : la discipline N'EST PAS la paralysie. Si un match remplit OBJECTIVEMENT
tous les critères chiffrés (ELO calibré, cote dans la plage, value mesurée,
compétition sérieuse), je DOIS le valider — sinon je trahis mes abonnés en
restant éternellement spectateur. Mes critères sont stricts pour qu'un pick
VALIDE soit fiable, pas pour que je ne picke jamais rien.
...
[ ] 5. TEST DU SOMMEIL : Si je publie ce pick et vais dormir, est-ce que je serais
       ...
       ⚠️ EXCEPTION SPORTS US (MLB/NBA/NHL) avec real_odds=true :
       Le test du sommeil PASSE automatiquement. Pourquoi : la moyenne des
       cotes de 30+ bookmakers EST la vérité du marché. Pas besoin de xG,
       de blessures, de H2H — si 30 books indépendants convergent sur une
       cote ET notre ELO calibré confirme l'avantage statistique attendu,
       il n'y a PAS d'information cachée. Tu peux dormir tranquille.
       Critères d'acceptation : MLB (ELO diff ≥150, cote ≥1.50, value ≥4%),
       NBA (ELO diff ≥100, cote ≥1.45), NHL (ELO diff ≥80, cote ≥1.55).
