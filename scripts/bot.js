...
const T = {
  fr: {
    ...
    pick_loading:   "⏳ Récupération du pick...",
    ...
    pick_odds:      "📊 Cote",
    pick_conf:      "🔥 Confiance",
    pick_footer:    "🎯 Jouez sur <a href='https://www.winamax.fr/parrain?code=77953728'>Winamax</a> ou <a href='https://www.betclic.fr/fr-fr/sports/?promocode=GREGA3GZ'>Betclic</a>\n⚠️ Jeu responsable · 18+ · Max 2-5% bankroll",
  ...
  en: {
    ...
    pick_loading:   "⏳ Fetching today's pick...",
    ...
    pick_footer:    "🎯 Play on <a href='https://www.winamax.fr/parrain?code=77953728'>Winamax</a> or <a href='https://www.betclic.fr/fr-fr/sports/?promocode=GREGA3GZ'>Betclic</a>\n⚠️ Responsible gambling · 18+ · Max 2-5% bankroll",
  ...
  es: {
    ...
    pick_loading:   "⏳ Cargando pronóstico...",
    ...
    pick_odds:      "📊 Cuota",
    pick_conf:      "🔥 Confianza",
    pick_footer:    "🎯 Juega en <a href='https://www.winamax.fr/parrain?code=77953728'>Winamax</a> o <a href='https://www.betclic.fr/fr-fr/sports/?promocode=GREGA3GZ'>Betclic</a>\n⚠️ Juego responsable · +18 · Máx. 2-5% bankroll",
  ...
  it: {
    ...
    pick_loading:   "⏳ Caricamento pronostico...",
    ...
    pick_odds:      "📊 Quota",
    pick_conf:      "🔥 Fiducia",
    pick_footer:    "🎯 Gioca su <a href='https://www.winamax.fr/parrain?code=77953728'>Winamax</a> o <a href='https://www.betclic.fr/fr-fr/sports/?promocode=GREGA3GZ'>Betclic</a>\n⚠️ Gioco responsabile · 18+ · Massimo 2-5% bankroll",
  ...
  ru: {
    ...
    pick_loading:   "⏳ Загрузка прогноза...",
    ...
    pick_footer:    "🎯 Играйте на <a href='https://www.winamax.fr/parrain?code=77953728'>Winamax</a> или <a href='https://www.betclic.fr/fr-fr/sports/?promocode=GREGA3GZ'>Betclic</a>\n⚠️ Ответственная игра · 18+ · Макс. 2-5% банкролла",
...
async function showMenu(chatId, lang, msgId = null) {
...
async function showPick(chatId, lang, msgId = null) {
...
async function showStats(chatId, lang, msgId = null) {
  const s = getStats();
...
async function showHow(chatId, lang, msgId = null) {
...
async function showLangMenu(chatId, lang, msgId = null) {
  const text = t(lang, "lang_menu");
  const kb   = kbLanguages(true);
  if (msgId) return editMsg(chatId, msgId, text, kb);
  return send(chatId, text, kb);
}
...
async function handleUpdate(update) {
  ...
  if (update.message) {
    ...
    if (text === "/start" || text === "/menu" || text === "/retour") {
      if (!sess.lang) {
        ...
        await showMenu(chatId, sess.lang);
      }
      return;
    }
    if (text === "/pick")  { await showPick(chatId, sess.lang || "fr");  return; }
    if (text === "/stats") { await showStats(chatId, sess.lang || "fr"); return; }
    if (text === "/help")  { await showHow(chatId, sess.lang || "fr");   return; }
    if (text === "/lang" || text === "/langue") {
      await showLangMenu(chatId, sess.lang || "fr");
      return;
    }

    // Message inconnu → renvoie le menu principal
    if (sess.lang) {
      await showMenu(chatId, sess.lang);
    } else {
      await showWelcome(chatId);
  ...
  if (update.callback_query) {
    ...
    switch (data) {
      ...
      default:
        await showMenu(chatId, lang, msgId);
    }
  }
}
