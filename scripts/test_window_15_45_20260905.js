...
vm.runInContext(section('function isClientOu25MatchEligible(', 'function clientOu25RequiredVotes('), ctx);
...
assert.deepEqual(rules,{ok:true,from_minute:15,to_minute:45,delivery_from_minute:35,delivery_to_minute:45,min_votes:4,min_confidence:77,min_odd:1.3,max_odd:2.1,min_rank_gap:5,top5_bottom5_priority:true});
