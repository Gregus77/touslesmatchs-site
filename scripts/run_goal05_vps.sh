...
export GOAL05_MIN_ODD="${GOAL05_MIN_ODD:-1.60}"
...
echo "[$(date -Is)] Demarrage Goal +0,5 autonome - seuil=$GOAL05_MIN_ODD jours=$GOAL05_SCAN_DAYS_AHEAD pages=$GOAL05_ODDS_PAGES deep=$GOAL05_MAX_DEEP_CANDIDATES"
