...
var bookmakers = [
  {nom:"Winamax", desc:"Le bookmaker francais numero 1. Bonus bienvenue jusqu a 200 EUR.", color:"#e8b400", link:WINAMAX_LINK, badge:"PARTENAIRE OFFICIEL"},
  {nom:"Betclic", desc:"Cotes competitives, retrait rapide. Ideal pour les paris sportifs.", color:"#00a651", link:BETCLIC_LINK, badge:"RECOMMANDE"},
];
...
export default function App() {
  ...
  var header = React.createElement("header", {style:{borderBottom:"1px solid rgba(212,175,55,0.2)",padding:"16px 30px",display:"flex",justifyContent:"space-between",alignItems:"center",background:"rgba(8,12,20,0.98)",position:"sticky",top:0,zIndex:50,flexWrap:"wrap",gap:"10px"}},
    ...
    React.createElement("nav", {style:{display:"flex",gap:"8px",alignItems:"center",flexWrap:"wrap"}},
      React.createElement("button", {onClick:function(){setPage("home");}, style:{background:page==="home"?"rgba(212,175,55,0.15)":"transparent",border:"1px solid "+(page==="home"?"#d4af37":"rgba(255,255,255,0.1)"),color:page==="home"?"#d4af37":"#666",padding:"6px 14px",borderRadius:"4px",cursor:"pointer",fontSize:"12px"}}, "Picks"),
      React.createElement("button", {onClick:function(){setPage("preuves");}, style:{background:page==="preuves"?"rgba(212,175,55,0.15)":"transparent",border:"1px solid "+(page==="preuves"?"#d4af37":"rgba(255,255,255,0.1)"),color:page==="preuves"?"#d4af37":"#666",padding:"6px 14px",borderRadius:"4px",cursor:"pointer",fontSize:"12px"}}, "Preuves"),
      React.createElement("button", {onClick:function(){setPage("bookmakers");}, style:{background:page==="bookmakers"?"rgba(212,175,55,0.15)":"transparent",border:"1px solid "+(page==="bookmakers"?"#d4af37":"rgba(255,255,255,0.1)"),color:page==="bookmakers"?"#d4af37":"#666",padding:"6px 14px",borderRadius:"4px",cursor:"pointer",fontSize:"12px"}}, "Bookmakers"),
    ...
    return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
      ...
      React.createElement("div", {style:{maxWidth:"900px",margin:"0 auto",padding:"40px 30px"}},
          ...
          preuves.map(function(p,i){
            return React.createElement("div", {key:i, style:{background:"rgba(212,175,55,0.04)",border:"1px solid rgba(212,175,55,0.15)",borderRadius:"10px",overflow:"hidden"}},
              p.img
                ...
                : React.createElement("div", {style:{width:"100%",height:"180px",background:"rgba(212,175,55,0.05)",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:"8px"}},
                    React.createElement("div", {style:{fontSize:"32px",opacity:"0.3"}}, ""),
                    React.createElement("div", {style:{color:"#333",fontSize:"12px",letterSpacing:"2px"}}, "CAPTURE A VENIR")
                  ),
        ...
        React.createElement("div", {style:{marginTop:"40px",padding:"24px",background:"rgba(212,175,55,0.04)",border:"1px solid rgba(212,175,55,0.15)",borderRadius:"10px",textAlign:"center"}},
          ...
          React.createElement("a", {href:WINAMAX_LINK, target:"_blank", style:{display:"inline-block",background:"linear-gradient(135deg,#d4af37,#f5d76e)",borderRadius:"6px",padding:"12px 30px",color:"#080c14",fontWeight:"bold",textDecoration:"none",fontSize:"14px"}}, "Ouvrir un compte Winamax")
        )
      )
    );
  }
  ...
  if(page === "bookmakers") {
    return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
      header,
      React.createElement("div", {style:{maxWidth:"800px",margin:"0 auto",padding:"40px 30px"}},
        React.createElement("h2", {style:{color:"#d4af37",letterSpacing:"3px",fontSize:"14px",marginBottom:"8px"}}, "NOS BOOKMAKERS PARTENAIRES"),
        React.createElement("p", {style:{color:"#555",fontSize:"13px",marginBottom:"8px"}}, "Tous nos partenaires sont agrees ANJ (Autorite Nationale des Jeux). Paris 100% legaux en France."),
        React.createElement("p", {style:{color:"#444",fontSize:"11px",marginBottom:"30px"}}, "En vous inscrivant via nos liens, vous nous aidez a continuer ce projet gratuitement. Merci."),
        React.createElement("div", {style:{display:"flex",flexDirection:"column",gap:"16px"}},
          bookmakers.map(function(b,i){
            return React.createElement("div", {key:i, style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"24px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"16px"}},
              React.createElement("div", null,
                React.createElement("div", {style:{display:"flex",alignItems:"center",gap:"10px",marginBottom:"8px"}},
                  React.createElement("div", {style:{fontSize:"20px",fontWeight:"bold",color:"#fff"}}, b.nom),
                  React.createElement("span", {style:{background:"rgba(212,175,55,0.15)",border:"1px solid rgba(212,175,55,0.3)",borderRadius:"3px",padding:"2px 8px",color:"#d4af37",fontSize:"10px",letterSpacing:"1px"}}, b.badge)
                ),
                React.createElement("p", {style:{color:"#666",fontSize:"13px",margin:0,maxWidth:"400px"}}, b.desc)
              ),
              React.createElement("a", {href:b.link, target:"_blank", style:{background:"linear-gradient(135deg,#d4af37,#f5d76e)",borderRadius:"6px",padding:"12px 28px",color:"#080c14",fontWeight:"bold",textDecoration:"none",fontSize:"13px",whiteSpace:"nowrap"}}, "S inscrire maintenant")
            );
          })
        ),
        React.createElement("div", {style:{marginTop:"30px",padding:"20px",border:"1px solid rgba(255,255,255,0.05)",borderRadius:"8px",textAlign:"center"}},
          React.createElement("p", {style:{color:"#333",fontSize:"11px",margin:0,lineHeight:"1.8"}}, "Le jeu peut etre dangereux. Jouez de maniere responsable. 18+ uniquement. joueurs-info-service.fr")
        )
      )
    );
  }
  ...
  return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
    ...
    React.createElement("section", {style:{padding:"10px 30px 40px",maxWidth:"980px",margin:"0 auto"}},
    ...
    React.createElement("section", {style:{padding:"0 30px 60px",maxWidth:"780px",margin:"0 auto"}},
      React.createElement("h2", {style:{color:"#d4af37",fontSize:"12px",letterSpacing:"3px",marginBottom:"14px"}}, "NOS PARTENAIRES"),
      React.createElement("div", {style:{display:"flex",flexDirection:"column",gap:"10px"}},
        bookmakers.map(function(b,i){
          return React.createElement("div", {key:i, style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:"10px",padding:"18px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"12px"}},
            React.createElement("div", null,
              React.createElement("div", {style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"4px"}},
                React.createElement("span", {style:{fontSize:"16px",fontWeight:"bold",color:"#fff"}}, b.nom),
                React.createElement("span", {style:{background:"rgba(212,175,55,0.1)",border:"1px solid rgba(212,175,55,0.2)",borderRadius:"3px",padding:"1px 6px",color:"#d4af37",fontSize:"9px",letterSpacing:"1px"}}, b.badge)
              ),
              React.createElement("p", {style:{color:"#555",fontSize:"12px",margin:0}}, b.desc)
            ),
            React.createElement("a", {href:b.link, target:"_blank", style:{background:"linear-gradient(135deg,#d4af37,#f5d76e)",borderRadius:"5px",padding:"10px 22px",color:"#080c14",fontWeight:"bold",textDecoration:"none",fontSize:"12px",whiteSpace:"nowrap"}}, "S inscrire")
          );
        })
      ),
      React.createElement("p", {style:{color:"#333",fontSize:"10px",textAlign:"center",marginTop:"16px"}}, "Jeu responsable 18+ - joueurs-info-service.fr")
    )
  );
}