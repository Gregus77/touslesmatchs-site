...
var BREVO_API_KEY = "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";
...
var bookmakers = [
  {nom:"Winamax", badge:"PARTENAIRE N1", bonus:"Bonus jusqu a 200 EUR", desc:"Le bookmaker francais numero 1. Cotes excellentes, interface top, retrait rapide.", link:WINAMAX_LINK, note:"9.5/10"},
  {nom:"Betclic", badge:"TOP COTES", bonus:"Bonus bienvenue 100 EUR", desc:"Cotes tres competitives surtout sur le foot europeen. Appli mobile excellente.", link:BETCLIC_LINK, note:"9.2/10"},
  {nom:"Unibet", badge:"FIABLE", bonus:"Mise remboursee 100 EUR", desc:"Bookmaker international solide. Large choix de sports et de marches.", link:UNIBET_LINK, note:"8.8/10"},
  {nom:"PMU", badge:"100% FRANCAIS", bonus:"Bonus 150 EUR", desc:"L historique des paris en France. Ideal pour le foot et les courses hippiques.", link:PMU_LINK, note:"8.5/10"},
  {nom:"ZEbet", badge:"COTES ELEVEES", bonus:"Remboursement 100 EUR", desc:"Specialiste des cotes boostees. Souvent les meilleures cotes sur certains matchs.", link:ZEBET_LINK, note:"8.3/10"},
  {nom:"ParionsSport", badge:"FDJ OFFICIEL", bonus:"Bonus 100 EUR", desc:"Le pari sportif officiel de la FDJ. Securite maximale, ideal pour les debutants.", link:PARIONSSPORT_LINK, note:"8.0/10"},
  {nom:"NetBet", badge:"BONNE VALEUR", bonus:"Bonus 100 EUR", desc:"Bon rapport qualite/cotes. Interface simple et claire.", link:NETBET_LINK, note:"7.8/10"},
];
...
function NewsletterForm() {
  ...
  function handleSubmit() {
    ...
    .catch(function() { setStatus("success"); setEmail(""); });
  }

  return React.createElement("div", {style:{background:"rgba(212,175,55,0.05)",border:"1px solid rgba(212,175,55,0.2)",borderRadius:"12px",padding:"30px",textAlign:"center",maxWidth:"600px",margin:"0 auto"}},
    React.createElement("div", {style:{fontSize:"10px",letterSpacing:"4px",color:"#d4af37",marginBottom:"8px"}}, "NEWSLETTER GRATUITE"),
    React.createElement("h3", {style:{color:"#fff",fontSize:"20px",margin:"0 0 8px"}}, "Recevez le pick du jour par email"),
    React.createElement("p", {style:{color:"#555",fontSize:"12px",marginBottom:"20px"}}, "1 email par jour maximum. Desabonnement en 1 clic. Gratuit."),
    status === "success"
      ? React.createElement("div", {style:{color:"#22cc44",fontSize:"14px",padding:"12px",background:"rgba(34,180,60,0.1)",borderRadius:"6px"}}, "Inscription reussie ! Vous recevrez le prochain pick.")
      : status === "already"
      ? React.createElement("div", {style:{color:"#d4af37",fontSize:"14px",padding:"12px",background:"rgba(212,175,55,0.1)",borderRadius:"6px"}}, "Vous etes deja inscrit !")
      : React.createElement("div", {style:{display:"flex",gap:"8px",maxWidth:"400px",margin:"0 auto",flexWrap:"wrap",justifyContent:"center"}},
          React.createElement("input", {
            ...
            style:{flex:"1",minWidth:"200px",padding:"10px 14px",background:"rgba(255,255,255,0.05)",border:"1px solid "+(status==="error"?"#ff4444":"rgba(255,255,255,0.15)"),borderRadius:"6px",color:"#fff",fontSize:"13px",outline:"none"}
          }),
          React.createElement("button", {
            onClick:handleSubmit,
            disabled:status==="loading",
            style:{background:"linear-gradient(135deg,#d4af37,#f5d76e)",border:"none",borderRadius:"6px",padding:"10px 20px",color:"#080c14",fontWeight:"bold",cursor:"pointer",fontSize:"13px",whiteSpace:"nowrap"}
          }, status==="loading" ? "..." : "Je m inscrits")
        )
  );
}
...
export default function App() {
  ...
  if(page==="preuves"){
    return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
      ...
      React.createElement("div", {style:{maxWidth:"900px",margin:"0 auto",padding:"40px 30px"}},
        ...
        React.createElement("div", {style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))",gap:"16px",marginBottom:"40px"}},
  ...
  if(page==="bookmakers"){
    return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
      ...
      React.createElement("div", {style:{maxWidth:"860px",margin:"0 auto",padding:"40px 30px"}},
        ...
        React.createElement("p", {style:{color:"#444",fontSize:"11px",marginBottom:"30px"}}, "En vous inscrivant via nos liens vous nous aidez a maintenir ce service gratuit."),
        React.createElement("div", {style:{display:"flex",flexDirection:"column",gap:"12px",marginBottom:"40px"}},
        ...
        React.createElement(NewsletterForm, null),
        React.createElement("div", {style:{marginTop:"20px",padding:"16px",textAlign:"center"}},
          React.createElement("p", {style:{color:"#2a2a2a",fontSize:"11px",margin:0}}, "Jeu responsable 18+ uniquement - joueurs-info-service.fr - 09 74 75 13 13")
        )
      )
    );
  }
  ...
  return React.createElement("div", {style:{background:"#080c14",minHeight:"100vh",fontFamily:"Georgia,serif",color:"#e8e0d0"}},
    ...
    React.createElement("section", {style:{padding:"20px 30px 60px",maxWidth:"780px",margin:"0 auto"}},
