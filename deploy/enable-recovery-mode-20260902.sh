...
BASE_SHA="7f0876f94238ca5488e5a3a32091354b4145740f"
TARGET_SHA="103a07578465940f2953dc9e7aa13ca8176e413c"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
BACKUP_DIR="/opt/backups/tlm-recovery-mode-${STAMP}"
...
console.log(JSON.stringify({ok:true,mode:"Recovery",daily_max:2,confidence_min:78,votes:"5/5",live_window:"15-40",fail_closed:true}));
'

trap - ERR
rm -rf "$TMP_DIR"
echo "OK — Mode Recovery actif et verifie; sauvegarde=$BACKUP_DIR"
